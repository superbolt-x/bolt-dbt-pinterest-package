...
{%- set schema_name, table_name = 'pinterest_raw', 'pin_promotion_report' -%}
{% set raw_tables = dbt_utils.get_relations_by_pattern('pinterest_raw%', 'pin_promotion_report') %}
...
SELECT 
    *,
    ...
    pin_promotion_id||'_'||date as unique_key
FROM staging
{% if is_incremental() -%}
